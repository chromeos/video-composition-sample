...
package dev.chromeos.videocompositionsample.presentation.tools.exception

import android.content.Context
import androidx.annotation.StringRes
import dev.chromeos.videocompositionsample.presentation.R

class ErrorModel(private val message: String? = "",
    ...
    fun getMessage(context: Context): String {
        return if (message.isNullOrEmpty()) {
            ...
            if (errorMessage.isEmpty())
                context.getString(R.string.error__something_went_wrong)
            else
                errorMessage
        } else {
            message
